...
- 授權：來源頁標示為 [Creative Commons Zero 1.0 Universal（CC0）](https://creativecommons.org/publicdomain/zero/1.0/)，可免費用於個人與商業作品。
- 用途：成熟植物、農具與自動收割機透明 PNG。
...
- Canvas 會以統一的接地基準繪製方向素材；伐木設備另外繪製圓鋸或木材載荷標記，肥料車則在 `kenney-truck-flat` 平板車上繪製料斗、支架與旋轉撒粒盤，讓功能與車型保持可辨識。
